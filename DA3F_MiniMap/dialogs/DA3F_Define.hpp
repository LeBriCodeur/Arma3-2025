...
*/
		...
		class DA3F_Btn_NoBg: DA3F_Btn {
			...
			animTexturePressed = "";
			animTextureDefault = "";		
		    soundEnter[] = {"\A3\ui_f\data\sound\RscButtonMenu\soundEnter",0,0};
		    soundPush[] = {"\A3\ui_f\data\sound\RscButtonMenu\soundPush",0,0};
		    soundClick[] = {"\A3\ui_f\data\sound\RscButtonMenu\soundClick",0,0};
		    soundEscape[] = {"\A3\ui_f\data\sound\RscButtonMenu\soundEscape",0,0};	
		};
		
		class DA3F_Btn_Custom: DA3F_Btn {
			idc = -1;
			type = CT_BUTTON;
			style = ST_CENTER;
			sizeEx = 0.038;
			...
			colorDisabled[] = {};
			color[] = {0,0,0,1};
			colorBackground[] = {0.9,0.2,0,0.95};
			offsetX = 0;//0.005;
			offsetY = 0;//0.003;
			offsetPressedX = 0.0055;
			offsetPressedY = 0;// 0.002;
			colorBackgroundActive[] = {0.8,0.3,0,1};
			colorBackgroundDisabled[] = {};		
			colorShadow[] = {0, 1, 0.1, 0.9};
			colorBorder[] = {0, 0.55, 1, 0.9};
			shadow = 1;
			borderSize = 0.006;			
			soundClick[] = {"", 0.5, 1};
			soundEnter[] = {"", 0.5, 1};
		...
		// 	color2[] = {0,0.85,0.2,1};
		// 	onbuttonclick = "closeDialog 0";
		// 	animTextureNormal = "images\GUI\rad\btn_Rad_1.paa";
		// 	animTextureDisabled = "images\GUI\rad\btn_Rad_1.paa";
		// 	animTextureOver = "images\GUI\rad\btn_Rad_1.paa";
		// 	animTextureFocused = "images\GUI\rad\btn_Rad_1.paa";
		// 	animTexturePressed = "images\GUI\rad\btn_Rad_1.paa";
		// 	animTextureDefault = "images\GUI\rad\btn_Rad_1.paa";		
		// };
		...
		class DA3F_TreeSearch
		{
			...
			colorPicture[] = {1,1,1,1};
			colorBackground[] = {0,0.2,0.4,1}; // Fill color
			colorSelect[] = {0, 0.5, 0.65, 0.75}; // Selected item fill color (when multiselectEnabled is 0)
			colorMarked[] = {0, 0.5, 0.65, 0.35}; // Marked item fill color (when multiselectEnabled is 1)
			colorMarkedSelected[] = {0, 0.5, 0.65, 0.75};
			colorText[] = {0.05,0.65,0.95,0.85};
			colorSelectText[] = {0.05,0.7,0.95,1};
			colorDisabled[] = {1, 1, 1, 0.25}; 
			colorSearch[] = {1,0.3,0,0.95};
			...
			class ScrollBar: DA3F_RscScrollBar {};
			style = 0; 
		...
		class DA3F_Tree
		{
			...
			x = 0.5; // Horizontal coordinates
			y = 0.5; // Vertical coordinates
			w = 0.5; // Width
			h = 0.5; // Height
			...
			colorSelect[] = {0, 0.5, 0.65, 0.75}; // Selected item fill color (when multiselectEnabled is 0)
			colorMarked[] = {0, 0.5, 0.65, 0.35}; // Marked item fill color (when multiselectEnabled is 1)
			colorMarkedSelected[] = {0, 0.5, 0.65, 0.75}; // Selected item fill color (when multiselectEnabled is 1)
			colorPictureSelected[] = {1,1,1,1};
			colorPictureDisabled[] = {1,1,1,1};
			colorPictureRight[] = {1,1,1,1};
			...
			//colorPictureCenter[] = {1,1,1,1};
			sizeEx = GUI_GRID_CENTER_H; // Text size
			font = GUI_FONT_NORMAL; // Font from CfgFontFamilies
			shadow = 2; // Shadow (0 - none, 1 - N/A, 2 - black outline)
			colorText[] = {0.05,0.65,0.95,0.85}; // Text color
			colorSelectText[] = {0.05,0.7,0.95,1}; // Selected text color (when multiselectEnabled is 0)
